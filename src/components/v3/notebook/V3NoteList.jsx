        ...
        <div className="flex flex-col h-full bg-white">
            <div className="p-4 space-y-4 bg-stone-50/50 sticky top-0 z-10 border-b border-stone-100">
                <div className="flex items-center justify-between">
                    <h2 className="text-lg font-bold text-stone-900">Notebook</h2>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-white border-none rounded-xl h-11 pl-10 pr-4 text-sm focus:ring-1 focus:ring-teal-500 shadow-sm"
                    />
                </div>
            </div>
