...
export default function PractitionerChatSection({ practitionerId, practitionerEmail, practitionerName }) {
  ...
  const currentUserEmail = useMemo(() => {
    ...
    return currentUser?.email;
  }, [currentView, currentUser, viewingAsPractitionerId, practitioners]);

  const currentUserRole = useMemo(() => {
    if (currentView === 'coach') return 'coach';
    if (currentView === 'practitioner') return 'practitioner';
    return 'coach';
  }, [currentView]);
  ...
  // Find conversation with this practitioner
  const conversation = useMemo(() => {
    if (!currentUserEmail || !practitionerEmail) return null;
    return conversations.find(c => 
      (c.participant1 === currentUserEmail && c.participant2 === practitionerEmail) ||
      (c.participant2 === currentUserEmail && c.participant1 === practitionerEmail)
    );
  }, [conversations, currentUserEmail, practitionerEmail]);
  ...
  // Check permissions: only show in coach or practitioner view, not client view
      ...
      >
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-lg">
            ...
            💬 Messages with {practitionerName}
        ...
        <CardContent className="p-6">
          {!conversation ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">No messages yet with {practitionerName}</p>
              <Button
